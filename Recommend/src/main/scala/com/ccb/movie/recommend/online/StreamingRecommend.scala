package com.ccb.movie.recommend.online

import java.sql.ResultSet

import com.ccb.movie.commons.conf.ConfigurationManager
import com.ccb.movie.commons.constant.Constants
import com.ccb.movie.commons.model.MySqlConfig
import com.ccb.movie.commons.pool.{CreateMySqlPool, CreateRedisPool, MySqlProxy, QueryCallback}
